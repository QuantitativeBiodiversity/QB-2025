---
title: '12\. Team Diversity Projects'
...
There are a few places you might look for biodiversity data sets, including ESA data papers (<http://www.esapubs.org/archive/search.php>), the LTER data portal (<https://portal.lternet.edu/nis/home.jsp>), the Dryad digital repository (<http://datadryad.org/>), and the NEON data portal (<https://data.neonscience.org/>).
...
4) If there is an experimental manipulation or underlying question, this will make your project more inspiring and interesting to talk about. 
...
You will need visualize the data and test hypotheses when appropriate. You will create an RMarkdown document that contains your data, code, and figures. This will be submitted by **12:00 (noon) on Wednesday, March 5, 2025**

## PRESENTATIONS
You and your partner will give a joint, 10-15 minute presentation to QB on the last day of class (i.e., March 3) using powerpoint or google slides. 
The slides for your presentation should be pushed to GitHub by **12:00 (noon) on Thursday, March 6, 2025**
