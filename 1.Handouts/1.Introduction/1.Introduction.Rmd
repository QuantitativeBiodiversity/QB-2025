...
Any modification that you make in a project (e.g., file created or package installed) are saved within that project, but all new projects created (ex: "New RStudio Project") are separate clean slates.
