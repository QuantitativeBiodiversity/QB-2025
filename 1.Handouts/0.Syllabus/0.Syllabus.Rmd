---
title: "Syllabus"
author: "Z620: Quantitative Biodiversity, Indiana University, 2023"
header-includes:
   - \usepackage{array}
output: pdf_document
...
### Class meetings
9:30-12:00 Friday, room 004 in [Fine Arts (FA)](https://tinyurl.com/4n26atjn), January 13 - March 3, 2023  
...
### Week 5
**Diversity synthesis**
We will recap and reinforce concepts from previous weeks while introducing new activities and tools. We will construct a site-by-species matrix, introduce basic programming methods, and use simulation methods to sample and analyze biodiversity data. 
