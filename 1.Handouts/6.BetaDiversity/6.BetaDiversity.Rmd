...
rm(list = ls())
getwd()
setwd("~/GitHub/QB-2025/1.HandOuts/6.BetaDiversity")
...
# Some reports of problems with `BiodiversityR` package
# In particular with generation of species scores in PCoA.
# Alternative is to load function from source file
# source("../bin/spec.scores.function.R")
```
