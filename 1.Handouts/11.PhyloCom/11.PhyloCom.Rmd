...
# (some warnings; may want to consider using melt fucntion from library(reshape2))
...
Finally, let's test whether the slopes for taxonomic and phylogenetic DD are significantly different from one another using the permutation-based `diffslope()` function, which is source code in the bin folder:
