...
rm(list=ls())
getwd()
setwd("~/GitHub/QB-2023/1.HandOuts/8.SpatialDiversity")
```
...
Because the API key is linked to a credit card, we are not going to print our 39 character code. 
