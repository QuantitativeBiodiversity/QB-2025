...
Immediately following the text that already exists in this file, take a few minutes to supply the following:
...
9. After generating token, make sure you copy and save; you will need this for next step. Note that when you paste your token into the password prompt in the Terminal, you will not be able to see the token characters. 
