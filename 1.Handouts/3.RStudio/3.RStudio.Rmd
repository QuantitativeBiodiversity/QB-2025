...
If you are working in Posit.cloud, you type the following into the the console (without the # sign). 

```{r}
#setwd("/cloud/project/QB-2025/Week-1")
```

When you type `"/cloud/project/"`, this will take you to the root of the Posit.cloud directory. 
When you type `QB-2025`, this will take you to the QB workspace. Instructors will push worksheets and data sets to this location for you to fetch and merge each week.
When you type `Week-1`, this is moves you to the folder containing Markdown files and a folder that contains data you will need for the exercises that are associated with this RStudio module. 

If you are working on your personal computer without Posit.cloud, you might change your working directory to something that looks like this, which would reflect where your GitHub files are being locally kept:
...
Using Posit.cloud, you can do this as follows, after removing the # sign: 

```{r}
#meso <- read.table("/cloud/project/QB-2025/Week-1/data/zoop_nuts.txt", sep = "\t", header = TRUE)
```

If you are using your personal computer without Posit.cloud, you would load the file like this:
