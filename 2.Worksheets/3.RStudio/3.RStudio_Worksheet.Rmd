...
This will save the PDF output in your Posit.cloud workspace: `/cloud/project/QB-2025/Week-1/`
...
3) set your working directory to your `Week-1/` folder. 
...
In the R code chunk below, do the following: 
1) Load `matrix.txt` from the **Week-1** data folder as matrix `m`.
...
In the R code chunk below, do the following:
1) Load the zooplankton data set from the **Week-1/** data folder.
